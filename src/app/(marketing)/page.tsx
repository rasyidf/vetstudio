...
const features = [
  {
    ...
    description: "Doloribus placeat labore illum veritatis? Inventore accusantium ratione placeat deleniti labore voluptatibus. Dolorum quidem quibusdam debitis tempora est ipsa totam distinctio porro.",
    fillRule: "even-odd"
  },
  {
    svgPath:
    ...
    description: "Veritatis repudiandae molestias architecto mollitia minima provident, fugit iusto optio illo fuga vitae, totam necessitatibus delectus amet fugiat qui quo. In, alias.",
    fillRule: "even-odd"
 },
  {
    svgPath:
    ...
    description: "Totam quia distinctio, corporis impedit ipsa nam velit ratione iusto obcaecati quis mollitia blanditiis eligendi. Deleniti, maiores. Porro, nobis tempore. Explicabo, aliquam!",
    fillRule: "even-odd"
